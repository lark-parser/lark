...
class Tree:
    ...
    meta: Meta
    def __init__(self, data: str, children: List[Union[str, Tree]], meta: Optional[Meta] = None): ...
...
def pydot__tree_to_png(tree: Tree, filename: str, rankdir: Literal["TB", "LR", "BT", "RL"] = ..., **kwargs) -> None: ...
