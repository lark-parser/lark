...
class Parser(BaseParser):
    def __init__(self,  parser_conf, term_matcher, resolve_ambiguity=True, ignore = (), complete_lex = False, debug=False, priority_decay=1):
        BaseParser.__init__(self, parser_conf, term_matcher, resolve_ambiguity, debug, priority_decay)
